...
class TenantHeaderMiddleware:
    ...
    def __call__(self, request):
        ...
        # ⚡ CRÍTICO: NO resetear schema inmediatamente
        # En AWS RDS Aurora, esto puede interrumpir operaciones en background (notificaciones)
        # El schema se limpiará automáticamente en el próximo request
        # connection.set_schema_to_public()  # COMENTADO - causa pérdida de conexión
